...
#Full Trendline Filter
""" def trendlineFilter(ohlcData, minima, maxima, wick_percent, M_max):
    longwick_minima = longWickFilter(True, minima, wick_percent)
    longwick_maxima = longWickFilter(False, maxima, wick_percent)
    start_minima = highVolumeFilter(longwick_minima)
    start_maxima = highVolumeFilter(longwick_maxima)
    low_trendlines_keys = []
    high_trendlines_keys = []
    for i in start_maxima:
        for j in longwick_maxima:
